...
public class Executa {
	...
	/**
	 * Constrói String para ser exibida com as informações da ULA.
	 */
	@Override
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("Argumento 1: " + Integer.toString((int) ula1));
		builder.append("\n");
		builder.append("Argumento 2: " + Integer.toString((int) ula2));
		builder.append("\n");
		builder.append("Resultado: " + Integer.toString((int) resultado));
		builder.append("\n");
